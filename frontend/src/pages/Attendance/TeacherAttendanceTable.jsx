...
const TeacherAttendanceTable = ({attendanceData, userSearch}) => {
    ...
    return (
        <div className="p-4 bg-card rounded-xl shadow-lg">
            ...
            <div className="flex items-center gap-2 mb-6 border-b pb-4">
                ...
                <h2 className="text-2xl font-bold text-foreground">Teacher Attendance Overview</h2>
            </div>
                        ...
                        {dataToDisplay.map((teacher) => 
                            ...
                            <TableRow key={student.id}>
                                ...
                                <TableCell>
                                    ...
                                    <span className={`px-2.5 py-1 text-xs font-semibold rounded-full ${getStatusStyle(teacher.status)}`}>
                                        {teacher.status}
                                    </span>
                                </TableCell>
            ...
            <div className="mt-4 text-sm text-muted-foreground">
                Displaying {dataToDisplay.length} teacher records.
            </div>
        </div>
    );}
